package com.example.seventhweekapppt3.data.network

import android.util.Log
import com.example.seventhweekapppt3.data.network.api.CatAPI.API
import com.example.seventhweekapppt3.data.network.api.CatAPI.API_FAVOURITE
import com.example.seventhweekapppt3.data.network.api.CatAPI.API_KEY
import com.example.seventhweekapppt3.data.network.model.CatItemDto
import com.example.seventhweekapppt3.data.network.model.FavCatItemDto
import com.example.seventhweekapppt3.data.network.model.GetFavCatsItem
    ...
    private suspend fun <R> safeNetworkCall(action: suspend () -> R): R? {
        return withContext(Dispatchers.IO) {
            try {
                ...
                Log.e("Nebrog", e.message.toString(), e)
